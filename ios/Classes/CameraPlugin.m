    ...
    if (error) {
      ...
      cam.onFrameAvailable = ^{
          ...
          if (pixelBuffer != NULL) {
              ...
              BOOL stableValue = self.isStable(uiImage);
              [self.channel invokeMethod:@"camera.stableDetected" arguments:[NSNumber numberWithBool:stableValue]];
              NSLog(@"Stable value is %d", stableValue);
          }
